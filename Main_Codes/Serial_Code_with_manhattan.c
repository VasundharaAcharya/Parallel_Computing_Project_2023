/*This code is implementing the serial version of K-Medoids algorithm to cluster the gene samples. To validate the results of the clustering algorithm, we use the 
