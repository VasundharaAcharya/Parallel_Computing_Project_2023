/* Time and clockcycles required to read the codes serially. We have demonstrated it for AML/ALL dataset. To replace it with Rice dataset, replace training.txt with train_rice.txt*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <time.h>
